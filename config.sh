...
#install packages
sudo dnf -y install zsh gnome-tweaks ffmpeg gimp cmatrix lm_sensors neovim youtube-dl python3-speedtest-cli gcc kernel-devel make g++ chromium-browser-privacy telegram-desktop
